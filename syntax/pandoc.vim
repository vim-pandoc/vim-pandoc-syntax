...
command! -nargs=1 PandocHighlight call EnableEmbedsforCodeblocksWithLang(<f-args>)
command! -nargs=1 PandocUnhighlight call DisableEmbedsforCodeblocksWithLang(<f-args>)
